...
const DeviceIcon = ({ width = "1rem", height = "1rem", variant = "primary" }: Props) => {
  return (
    <svg
      width={width}
      height={height}
