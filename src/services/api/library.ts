import type { LibraryContains, LibraryTracks } from "../../types/library.ts";
...
export function fetchUserLibraryTracks(limit: number, offset: number) {
  return spotifyFetch<LibraryTracks>(`/me/tracks?limit=${limit}&offset=${offset}`);
}
